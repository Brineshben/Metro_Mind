...
class AddAssesment extends StatefulWidget {
  final String token;
  final String name;
  ...
  const AddAssesment({super.key, required this.name, required this.patientId,required this.sevirity, required this.id, required this.token,});

  @override
  State<AddAssesment> createState() => _AddAssesmentState();
}

class _AddAssesmentState extends State<AddAssesment> {
