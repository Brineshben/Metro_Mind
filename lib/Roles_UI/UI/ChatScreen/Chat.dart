...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final String _apiUrl = "http://192.168.1.29:8000/accounts/preliminary-chat/";
  ...
  void _sendMessage(types.PartialText message, {bool switchPress = false}) async {
    ...
    // Add session ID and switch press flag for subsequent messages
    ...
    if (response.statusCode == 200) {
      ...
      // Navigate if switch response is true
