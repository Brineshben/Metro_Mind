...
class DoneAssesment extends StatefulWidget {
  ...
  final String phone;
  const DoneAssesment({super.key, required this.name, required this.patientId,required this.questionText, required this.token, required this.phone, required this.thoughtID,});
