...
class HomeScreenPatient extends StatefulWidget {
  ...
  const HomeScreenPatient(
      {super.key, required this.name, required this.role, required this.token, required this.date, required this.patientId});
              ...
              children: [
                ...
                Obx(() {
                  ...
                  return ThoughtOfTheDayWidget(
                    ...
                    author: "-${controller.quotesData.value?.message?.author ??
                        "Brinesh ben"}",
                  );
                }),
                Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            _buildTag(
                                "View AI Report", Colorutils.userdetailcolor),
                            const SizedBox(width: 6),
                            _buildTag("ON PROGRESS", Colors.red),
                            const SizedBox(width: 6),
                            _buildTag("View", Colors.red),
                          ],
                        ),
                      ],
                    ),
