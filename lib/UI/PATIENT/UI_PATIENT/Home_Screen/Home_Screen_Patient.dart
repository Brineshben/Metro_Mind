...
class _HomeScreenPatientState extends State<HomeScreenPatient> {
  List<QuizSession> sessions = [
    ...
    QuizSession(title: "Mood Tracking", time: "Improving", instructor: "7 day trend :Positive"),
    QuizSession(title: "Therapy Progress", time: "65% Complete", instructor: "Treatment plan"),
    QuizSession(title: "Alerts", time: "2 New", instructor: "Home Work"),
  ];
