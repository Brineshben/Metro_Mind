...
class ApiServices {
  ...
  ///Add check OTP
  static Future<Map<String, dynamic>> checkOTP(String phoneNumber, String oTP) async {
  ...
  static Future<Map<String, dynamic>> ParticularMedicineList({
    ...
    String url = "${ApiConstants.baseURL}${ApiConstants.particularMedicineList}";
  ...
  static Future<Map<String, dynamic>> patientAssesmentList({
    ...
    String url = "${ApiConstants.baseURL}${ApiConstants.patientAssignmentList}$id/";
  ...
  assignmentCreate(
      {required int patientId,required String question,required String token}) async {
  ...
  static Future<Map<String, dynamic>> Editassignment(
      {required int thoughtsID,required String response,required String token}) async {
    String url = "${ApiConstants.baseURL}${ApiConstants.editAssignment}$thoughtsID/";
  ...
  static Future<Map<String, dynamic>> approveEnquiredList({
    ...
    String url = "${ApiConstants.baseURL}${ApiConstants.approveEnquiredList}$id/";
 ...
 ///Reject Enquiry LIST
  static Future<Map<String, dynamic>> rejectEnquiredList({
    ...
    String url = "${ApiConstants.baseURL}${ApiConstants.rejectEnquiredList}$id/";
    print("Enquiry List---$url");
